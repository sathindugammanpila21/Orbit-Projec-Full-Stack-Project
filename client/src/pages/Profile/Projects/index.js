  ...
  const renderActionButtons = (project) => (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="p-2 text-slate-500 rounded-full hover:bg-slate-100 hover:text-primary transition-colors"
      >
                  ...
                  projects.map((project) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span
                          className={`inline-block text-xs font-bold uppercase px-3 py-1 rounded-full ${getStatusStyles(
                            project.status
                          )}`}
                        >
                          {project.status}
